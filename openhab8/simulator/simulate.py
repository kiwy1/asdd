#!/usr/bin/env python3
"""Virtual Items Simulator — оновлює віртуальні Items через OpenHAB REST API."""
import os
import random
import time
import logging
...
INTERVAL = int(os.getenv("PUSH_INTERVAL", "15"))
...
def main():
    ...
    log.info("Waiting %ds for OpenHAB to load items...", startup_delay)
